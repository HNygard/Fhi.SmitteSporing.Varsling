...
namespace Fhi.Smittesporing.Varsling.Datalag.Migrations
{
    ...
    [Migration("20200608103500_NyKolonneVerifiseringskodeForSmittekontakt")]
    partial class NyKolonneVerifiseringskodeForSmittekontakt
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fhi.Smittesporing.Varsling.Domene.Modeller.Smittekontakt", b =>
                {
                    ...
                    b.Property<int?>("AntallDagerMedKontakt")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("BluetoothAntallDagerMedKontakt")
                        .HasColumnType("int");

                    b.Property<double>("BluetoothNarVarighet")
                        .HasColumnType("float");

                    b.Property<double>("BluetoothRelativtNarVarighet")
                        .HasColumnType("float");

                    b.Property<double>("BluetoothVeldigNarVarighet")
                        .HasColumnType("float");

                    b.Property<DateTime>("Created")
                        .HasColumnType("datetime2");

                    b.Property<string>("EnhetsinfoJson")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int?>("GpsAntallDagerMedKontakt")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PipelineVersjon")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("Verifiseringskode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Fhi.Smittesporing.Varsling.Domene.Modeller.SmittekontaktGpsHistogram", b =>
                {
                    b.Property<int>("SmittekontaktGpsHistogramId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("SmittekontaktGpsHistogramId");

                    b.HasIndex("SmittekontaktId")
                        .IsUnique();

                    b.ToTable("SmittekontaktGpsHistogram","Simula");
                });
            ...
            modelBuilder.Entity("Fhi.Smittesporing.Varsling.Domene.Modeller.SmsVarsel", b =>
                {
                    ...
                    b.Property<DateTime?>("SisteEksterneHendelsestidspunkt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Fhi.Smittesporing.Varsling.Domene.Modeller.SmittekontaktGpsHistogram", b =>
                {
                    b.HasOne("Fhi.Smittesporing.Varsling.Domene.Modeller.Smittekontakt", "Smittekontakt")
                        .WithOne("GpsHistogram")
                        .HasForeignKey("Fhi.Smittesporing.Varsling.Domene.Modeller.SmittekontaktGpsHistogram", "SmittekontaktId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
